...
test.describe("Авториация на Соус Демо", () => {  // описали набор теcтов

test('Пользователь должен успешно войти в систему', async ({  // описываем суть теста - успешный вход
    page }) => {
...
test('Пользователь заблокирован, неуспешный вход', async ({  // описываем суть теста - неуспешная попытка входа
    page }) => {
      await page.goto('https://www.saucedemo.com/'); // переход на страницу
